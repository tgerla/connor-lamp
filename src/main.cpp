...
#define DEBOUNCE_MS                                                            \
  20 // A debounce time of 20 milliseconds usually works well for tactile button
     // switches.
...
extern const char *gPaletteNames[];

volatile int idx = 0, ledClock = 0;
void lightUpdate() {
  CRGBPalette16 pal = gGradientPalettes[currentPalette];
  fill_palette(leds, NUM_LEDS, idx, 256 / NUM_LEDS, pal, 255, LINEARBLEND);
...
// Gradient palette "es_chic_22_gp", originally from
// http://soliton.vm.bytemark.co.uk/pub/cpt-city/es/chic/tn/es_chic_22.png.index.html
// converted for FastLED with gammas (2.6, 2.2, 2.5)
// Size: 20 bytes of program space.

DEFINE_GRADIENT_PALETTE(es_chic_22_gp){0,   252, 244, 228, 101, 206, 180,
                                       87,  178, 239, 207, 158, 252, 252,
                                       244, 228, 255, 252, 244, 228};

// Gradient palette "es_candide_33_gp", originally from
// http://soliton.vm.bytemark.co.uk/pub/cpt-city/es/candide/tn/es_candide_33.png.index.html
// converted for FastLED with gammas (2.6, 2.2, 2.5)
// Size: 16 bytes of program space.

DEFINE_GRADIENT_PALETTE(es_candide_33_gp){
    0, 0, 141, 255, 89, 60, 255, 255, 181, 255, 255, 255, 255, 255, 255, 255};
...
DEFINE_GRADIENT_PALETTE(cw1_029_gp){0,   12, 80,  210, 127, 255,
                                    235, 19, 255, 224, 66,  15};

// Gradient palette "cw2_038_gp", originally from
// http://soliton.vm.bytemark.co.uk/pub/cpt-city/cw/2/tn/cw2-038.png.index.html
// converted for FastLED with gammas (2.6, 2.2, 2.5)
// Size: 12 bytes of program space.

DEFINE_GRADIENT_PALETTE(cw2_038_gp){0,  1,  18,  23, 127, 3,
                                    50, 23, 255, 39, 130, 162};
...
DEFINE_GRADIENT_PALETTE(cw2_078_gp){0,  227, 69,  13, 127, 206,
                                    36, 22,  255, 49, 9,   3};

// Gradient palette "Chrome_Shine_gp", originally from
// http://soliton.vm.bytemark.co.uk/pub/cpt-city/lb/mp/tn/Chrome_Shine.png.index.html
// converted for FastLED with gammas (2.6, 2.2, 2.5)
// Size: 20 bytes of program space.

DEFINE_GRADIENT_PALETTE(Chrome_Shine_gp){0,   121, 136, 125, 30,  182, 191,
                                         184, 127, 255, 255, 255, 229, 182,
                                         191, 184, 255, 121, 136, 125};

// Gradient palette "HostGrad3_gp", originally from
// http://soliton.vm.bytemark.co.uk/pub/cpt-city/lb/mp/tn/HostGrad3.png.index.html
// converted for FastLED with gammas (2.6, 2.2, 2.5)
// Size: 12 bytes of program space.
