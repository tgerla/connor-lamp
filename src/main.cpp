...
// timers
MillisTimer cycleTimer = MillisTimer(1); //, cycleColors);
...
void setup() { 
  ...
  set_max_power_in_milliwatts(18000);
...
DEFINE_GRADIENT_PALETTE( es_chic_22_gp ) {
    0, 252,244,228,
  101, 206,180, 87,
  178, 239,207,158,
  252, 252,244,228,
...
DEFINE_GRADIENT_PALETTE( cw2_038_gp ) {
    0,   1, 18, 23,
  127,   3, 50, 23,
  255,  39,130,162};
...
DEFINE_GRADIENT_PALETTE( cw2_078_gp ) {
    0, 227, 69, 13,
  127, 206, 36, 22,
  255,  49,  9,  3};
...
DEFINE_GRADIENT_PALETTE( Chrome_Shine_gp ) {
    0, 121,136,125,
   30, 182,191,184,
  127, 255,255,255,
  229, 182,191,184,
...
DEFINE_GRADIENT_PALETTE( HostGrad3_gp ) {
    0,   2, 51,  5,
  127,  56,121,  7,
  255, 186,221, 89};
